...
const createChannelNick = document.getElementById("create-channel-nick");
...
function createChannelElement(channel) {
  ...
  div.innerHTML = `
    ...
    <span class="channel-users">${channel.userCount} 人</span>
...
function createChannel() {
  ...
  const nickName = createChannelNick.value.trim();
  ...
  const post = {
    channel: channelName,
    nick: nickName,
    content: description || `欢迎来到频道 #${channelName}！`,
    timestamp: Date.now(),
    image: null,
  ...
  localStorage.setItem('sc_last_nick', nickName);
